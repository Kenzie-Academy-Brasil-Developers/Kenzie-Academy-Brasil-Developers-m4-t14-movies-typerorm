...
import { IMoviesPages } from "../../interfaces";
import { retrieveMoviesSchema } from "../../schemas/movies.schemas";

const retrieveMovies = async (payload: any): Promise<IMoviesPages> => {
